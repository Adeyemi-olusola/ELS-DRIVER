...
class UploadVehicleImageView extends StatefulWidget {
  const UploadVehicleImageView({super.key});

  @override
  State<UploadVehicleImageView> createState() => _UploadVehicleImageViewState();
}

class _UploadVehicleImageViewState extends State<UploadVehicleImageView> {
  var imagePath;
